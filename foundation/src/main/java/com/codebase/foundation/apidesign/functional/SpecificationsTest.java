...
public class SpecificationsTest {
    ...
    public void testTRUE() {
        Assert.assertThat(Specifications.TRUE().satisfiedBy(new Object()), equalTo(true));
    }

    @Test
    public void testNot() {
        Assert.assertThat(Specifications.not(Specifications.TRUE()).satisfiedBy(new Object()), equalTo(false));
    }

    @Test
    public void testAnd() {
        Specification<Object> trueSpec = Specifications.TRUE();
        Specification<Object> falseSpec = Specifications.not(Specifications.TRUE());
